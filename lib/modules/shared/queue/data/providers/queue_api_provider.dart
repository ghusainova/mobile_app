...
import '../models/queue_branch_response.dart';
import '../models/active_client_dto.dart';
import '../models/manager_state_dto.dart';
import '../models/queue_length_response.dart';

part 'generated/queue_api_provider.g.dart';

@RestApi()
@lazySingleton
abstract class QueueApiProvider {
  @factoryMethod
  factory QueueApiProvider(Dio dio) = _QueueApiProvider;
